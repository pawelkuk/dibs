        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _loop_1 = function (j) {
                        var successList, errorList, expStart, movieTitles, seatsReserved, i, screeningsResponse, resps, res, reqs, error_1, successStats, errorStats, totalStats;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    ...
                                    _a.label = 1;
                                case 1:
                                    if (!(i < options.iterations)) return [3 /*break*/, 12];
                                ...
                                case 3:
                                    ...
                                    if (!seatsReserved) return [3 /*break*/, 6];
                                ...
                                case 8:
                                    ...
                                    return [3 /*break*/, 9];
                                case 9: return [4 /*yield*/, sleep(options.delay)];
                                case 10:
                                    _a.sent();
                                    _a.label = 11;
                                case 11:
                    ...
                    _a.label = 1;
                case 1:
                    if (!(j < options.numbersOfScreenings)) return [3 /*break*/, 4];
...
function writeDataToFile(successData, errorData, screening, options, expStart) {
    var fName = getFileName(screening, options, expStart);
...
function getFileName(screening, options, expStart) {
    var movie = slugify_1["default"](screening.movie);
    return Math.floor(expStart) + "_" + movie + "_" + options.mode + "_" + options.number + ".csv";
}
